...
angular.module('mentionrApp')
  .factory('dashboardFactory', function ($http) {
    ...
    var removeWord = function(word, userId) {
      return $http({
        url: '/api/words/' + userId + '/' + word,
        method: 'DELETE',
      });
    }
